"""
Plugin to automatically find large URLs and helpfully offer tiny URLs instead.

The Api class is part of python-bitly (http://code.google.com/p/python-bitly)
...
class BitLy(object):
    """
    Automatically submits large URLs to bit.ly and prints the result.
    """

    implements(IPlugin, IHackabotPlugin)

    def __init__(self):
        regex = "(http://\S{%d,})" % URL_MIN_LENGTH
        self._regex = re.compile(regex)

        self.api = Api(login="pythonbitly",apikey="R_06871db6b7fd31a4242709acaf1b6648")
